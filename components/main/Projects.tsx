...
const manualProjects = [
  ...
  },
  {
    ...
    description: 'End-to-end development of a Virtual Assistant Platform providing a customized dashboard for users based on their service. Built the Admin Panel and added multiple features.',
    language: 'typescript',
  ...
  },
  {
    ...
    description: 'Built a Digital Marketing Website providing customized digital solutions for clients to increase their online presence and engagement.',
    language: 'typescript',
    source: 'https://github.com/vishwam-shah/Krafting',
    liveDemo: 'https://Krafting.in',
    thumbnail: '/krafting.png',
  },
  {
    id: 'manual-4',
    name: 'Built LMS From Scratch',
    description: 'Built a full-featured Learning Management System with customized learning solutions, course management, and progress tracking for students and instructors.',
    language: 'typescript',
    source: 'https://github.com/vishwam-shah/lms',
    liveDemo: '',
    thumbnail: '/vidhyax_1.png',
  },
];
