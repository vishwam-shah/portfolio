  ...
  return (
    ...
    >
      ...
      w-[80%] bg-black overflow-auto rounded-xl border-[4px] border-[#2A0E61] p-8 flex flex-col gap-4'>
        ...
        <button type='button' className='button-primary text-gray-200 p-3 w-[100px] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 rounded-2xl border border-[#2A0E61]'><Link href={project.live} target="_blank">Live</Link></button>
        <button type='button' className='button-primary text-gray-200 p-3 w-[100px] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 rounded-2xl border border-[#2A0E61]'><Link href={project.source} target="_blank">Source</Link></button>
      </div>
      </motion.div>
    </motion.div>
  );
